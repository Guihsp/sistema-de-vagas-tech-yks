...
@WebServlet("/api/find3LastVacancy")
public class Find3LastVacancy extends HttpServlet {
    private VacancyDAO vacancyDAO;

    public Find3LastVacancy() {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ArrayList<VacancyModel> vacancies = vacancyDAO.find3LastVacancy();
